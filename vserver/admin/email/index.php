	...
	<!-- 側邊欄位區 -->
		...
		<section id="head_doc">
			...
			<table class="basetable">	
				<tr><td colspan=3 class="title">Email帳號列表 &nbsp;&nbsp;&nbsp;&nbsp;<a href="#add">新增信箱</a></td>
				</tr>
				<tr>
					<td colspan=3><?php include_once("./module/email_status.php"); ?></td>
				</tr>
			</table>
			<br>			
				<?php
					include_once("./module/email_data.php");
				?>
				<br>
				<a name="add"></a>
				<?php
					if ($reminder >0){
						include_once("./module/email_add.php");
					}
				?>
			<br>
