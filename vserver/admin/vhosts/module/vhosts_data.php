...
?>
<tr>	
<form action="./module/vhost_process.php" method="post">
<table class="inner_table2">
	<tr>
		<td colspan=5 style="border-bottom:1px solid rgb(147,174,6); hight: 30px;">&nbsp;&nbsp;&nbsp;虚擬網站資料</td></tr>
	<tr>
		<td class="inner_table_td"> 網站名稱</td>
		<td colspan=2>
			<input type="text" name="vhost_name" size="40" value="<?php echo $row['vhost'];?>"></input>
		</td>
		<td class="inner_table_td">網站別名</td>
		<td>
			<input type="text" name="vhost_alias" size="25" value="<?php echo $row['valias'];?>"></input>
		</td>
	</tr>
	<tr>
		...
		<td colspan=2><input type="text" name="path" size="30" value="<?php 
	...
	<tr>
		...
		<!-- <td class="inner_table_td">其他PHP設定</td>
		<td colspan=2>
			<input type="text" name="other" size=50 value="<?php echo $row['extra_php_config'];?>"></input>
		</td>
		-->
		<td colspan=3></td>
	</tr>
