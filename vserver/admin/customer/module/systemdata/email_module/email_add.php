<form action="./email_module/add_email_check.php" method="post"> 
<table class="inner_table">
	...
	<tr>
		...
		<td colspan=3><input type="text" name="name" size=45></input></td>
	</tr>
	<tr>
		<td class="inner_table_td">密碼</td>
		<td colspan=3><input type="text" name="passwd" size=30></input></td>
	</tr>
	<tr>
		<td colspan=4>
