	...
	<!-- 側邊欄位區 -->
		...
		<section id="head_doc">
			...
			<table class="basetable2">	
				<tr>
					<td colspan=6 class="title2">FTP 帳號資料列表</td>
				</tr>
				<tr>
					<td colspan=6>
						<?php 
							include_once("./ftp_module/ftp_count.php");
						?>
					</td>
				</tr>
				<tr>
				...
				<?php
					include_once("./ftp_module/ftp_data.php");
				?>
			</table>
				<br>
				<?php
				if (($reminder > 0) and ($reminder_user > 0)){
					include_once("./ftp_module/ftp_add_data.php");
				}
				?>
