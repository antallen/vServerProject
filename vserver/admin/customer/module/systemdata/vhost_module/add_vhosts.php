<form action="./vhost_module/add_check.php" method="post">
<table class="inner_table">
	<tr>
		<td colspan=4 style="border-bottom:1px solid rgb(147,174,6); hight: 30px;">&nbsp;&nbsp;&nbsp;新增網站資料</td></tr>
	<tr>
		<td class="inner_table_td"> 網站名稱</td>
		<td>
			<input type="text" name="vhost_name" size=30 value="例如：www.網域名稱"></input>
		</td>
		<td class="inner_table_td">網站別名</td>
		<td>
			<input type="text" name="vhost_alias" size=30 value="例如：網域名稱"></input>
		</td>
	</tr>
	<tr>
		...
		<!-- echo $main_path; -->
		<td><input type="text" name="path" size=30></input></td>
	</tr>
	<tr>
		...
		<td colspan=2>網站主目錄：<?php echo $main_path; ?>
	...
	<tr>
		<td>
			...
			<input type="hidden" value="<?php echo $_SESSION['manage_uid']; ?>" name="userID"></input>
