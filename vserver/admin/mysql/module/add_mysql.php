<form action="./module/mysql_add_check.php" method="post"> 
	<table class="inner_table">
		...
		<tr>
			...
			<td colspan=3><input type="text" name="database" value="<?php echo $row[0]; ?>" size="45"></input></td>
		</tr>
		<tr>
			<td class="inner_table_td">帳號名稱</td>
			<td><input type="text" name="loginname" value="<?php echo $row[2]; ?>" size=18></input></td>
			<td class="inner_table_td">密碼</td>
			<td><input type="text" name="passwd" value="<?php echo $row[1]; ?>" size=18></input></td>
		</tr>
		<tr>
			<td colspan=6>
