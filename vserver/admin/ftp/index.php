...
<!-- 文件資訊 -->
<head>
<title>Vserver 管理介面--FTP管理</title>
	...
	<!-- 側邊欄位區 -->
		...
		<section id="head_doc">
			...
			<table class="basetable">	
				<tr>
					<td colspan=6 class="title" width="98%">FTP 帳號資料列表
				...
				<tr>
					<td colspan=6>
						<?php 
							include_once("./module/ftp_count.php");
						?>
					</td>
				</tr>
			</table>
			...
			<table class="basetable">		
				<tr>
					<td class="title">帳號名稱</td>
					<td class="title">密碼</td>
					<td class="title">指定空間</td>
					<td class="title">已用空間</td>
					<td class="title" style="text-align: center;">子目錄</td>
					<td class="title" style="text-align: center;">異動</td>
				</tr>
				<?php
					include_once("./module/ftp_data.php");
				?>
				</table>
				<br>
				<?php
				if (($reminder > 0) and ($reminder_user > 0)){
					include_once("./module/ftp_add_data.php");
				}
				?>
